  ...
  export default {
      ...
      'Config.isSelected': {
        handler(curVal, oldVal){
          if (curVal) {
            ...
            propertyObject.type = 'u2DMapChina-mapstyle'
            propertyObject.title = '地图颜色设置'
            ...
            propertyObject1.type = 'u2DMapChina-mapconfig'
            propertyObject1.title = '动态图层配置'
            propertyObject1.props = this.componentConfig
            propertyArr1.push(propertyObject1)
            this.addPublicPropConfig(propertyArr1)
          }
        },
        deep: true
      },
    ...
    methods: {
      ...
      getComponentData() {
        ...
        switch (datatype) {
          case "json":
            this.uData = this.Config.datasource.value
       ...
       */
      initConfig() {
        this.componentOptions.geo.itemStyle.normal.areaColor = this.componentConfig.areaColor
        this.componentOptions.geo.itemStyle.normal.borderColor = this.componentConfig.borderColor
      ...
      initMapInnerComponents(data) {
        ...
        let animationLines = {
          ...
          effect: {
            ...
            period: 6,
            trailLength: 0.7,
            color: that.componentConfig.alColor,
            symbolSize: 3
          },
          lineStyle: {
            normal: {
              color: that.componentConfig.scatterColor,
              width: 0,
              curveness: 0.2
            }
          },
        ...
        if (this.componentConfig.isAnimationLine) {
          series.push(animationLines)
        }
